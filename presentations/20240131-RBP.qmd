...
- Includes code processing research data, scripts, and workflows: any code that runs in order to process your research data.
- Any scriptable language (R, Python, shell, etc.)
- Standalone programs for specific research tasks
- We have to manage it to have a record of all the steps used to process your data
:::
...
These can all be attenuated by adopting a few Software Engineering practices the main one being writing modular code
...
![](20240131-RBP_images/roxygen2.png){fig-align="center"}
...
![](20240131-RBP_images/cats.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](20240131-RBP_images/github-mark-white.png){fig-align="center" width="200"}
:::

::: {.column width="50%"}
![](20240131-RBP_images/gitlab-logo-500.png){fig-align="center" width="200"}
:::
:::
...
- [Reproducibility with renv](https://thezetner.github.io/quarto-presentations/presentations/20230704-renv.html#/title-slide)
:::
